...
function PlaceOrder() {
    ...
    const { cartItems, setCartItems, token, getCartAmount, delivery, products, userId, navigate } = useShop(); // Destructure userId from useShop
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            switch (method) {
                case "cod": {
                    const res = await axios.post("http://localhost:5000/api/order/placeOrder", orderData, {
                        headers: {
